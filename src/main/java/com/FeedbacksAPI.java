...
public class FeedbacksAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		 String output = feedbackObj.insertFeedback(request.getParameter("fbType"), 
				 request.getParameter("fbDesc"), 
				request.getParameter("fbRate")); 
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		Map paras = getParasMap(request); 
		 String output = feedbackObj.deleteFeedback(paras.get("feedbackID").toString()); 
		response.getWriter().write(output); 
	}
